...
def main():
	...
	# test set = 201 genes (ACKR1 + 100 each side)
	...
	# 		'PEA15', 'DCAF8', 'PEX19', 'COPA'

	# genes = ['NCSTN', 
	# 		'NHLH1', 'VANGL2', 'SLAMF6', 'CD84', 'SLAMF1', 
	# 		'CD48', 'SLAMF7', 'LY9', 'CD244', 'ITLN1', 
	...
	# 		'FCGR3B', 'FCGR2B', 'FCRLA', 'FCRLB', 'DUSP12', 
	# 		'ATF6', 'OLFML2B', 'NOS1AP', 'SPATA46', 'C1orf226', 
	# 		'SH2D1B', 'UHMK1', 'UAP1', 'DDR2', 'HSD17B7', 
	# 		'CCDC190', 'RGS4', 'RGS5', 'NUF2', 
	# genes = ['PBX1', 
	# 		'LMX1A', 'RXRG', 'LRRC52', 'MGST3', 'ALDH9A1', 
	# 		'TMCO1', 'UCK2', 'FAM78B', 'POGK', 'TADA1', 
	# 		'MAEL', 'GPA33', 'STYXL2', 'POU2F1', 'CD247', 
	# 		'CREG1', 'RCSD1', 'MPZL1', 'ADCY10', 'DCAF6', 
	# 		'GPR161', 'TIPRL', 'SFT2D2', 'TBX19', 'XCL2']

	genes = ['PEX19', 'COPA', 'NCSTN', 'NHLH1']
